...
base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'DataEscenas'))
folder = 'DatasetEscenas/'
...
for subfolder in subfolders:
    ...
    files = [f for f in os.listdir(current_folder_path) if f.endswith('.jpg')]
